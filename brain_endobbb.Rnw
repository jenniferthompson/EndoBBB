...
fit.nb.models <- function(use.marker,   ## character string; name of biomarker variable
                          formula.full, ## formula for full model formula
                          modtype = c('nb', 'zeroinfl'), ## Use NB or zero-inflated NB?
...
#   if(nbobj$p.int > 0.20){
#     return(list('fig' = plot.nb.results(nbobj = nbobj,
#                                         xvar = xvar,
#                                         xstring = xstring,
#                                         ystring = ystring),
#                 'height' =  4,
